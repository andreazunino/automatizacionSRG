...
export const createProductoFinancieroTestData = (): ProductoFinancieroTestData => {
  ...
  return {
    nombre: `Préstamo PYME Test ${suffix}`,
    nombreCopia: `Copia Préstamo PYME ${suffix}`,
    tipologia: 'Inversión',
    ...
    lineaComision: {
      ...
      importeMinimo: '1000',
      importeMaximo: '5000',
      periodicidad: 'Al tirón'
    },
    lineaComisionDuplicada: {
      concepto: 'Comisión estudio',
      tipo: 'Inversión',
      modo: 'Porcentual',
      porcentajeMinimo: '0.5',
      porcentajeMaximo: '2.0',
...
export const createProductoComisionTestData = (): ProductoComisionTestData => {
  ...
  return {
    nombre: `Comisión Aval Test ${suffix}`,
...
export const createConceptoComisionNoProtegidoTestData = (): ConceptoComisionNoProtegidoTestData => {
  ...
  return {
    nombre: `Comisión Personalizada Test ${suffix}`,
    nombreEditado: `Comisión Personalizada Test v2 ${suffix}`,
    codigo: `cpt${suffix}`,
...
export const createTipologiaProductoTestData = (): TipologiaProductoTestData => {
  ...
  return {
    ...
    nombreEditado: `Técnico v2 ${suffix}`
  };
};
